...
Shader "Toon"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float3 lerpResult73 = lerp( temp_cast_6 , indirectSpecular70 , _IndirectSpecularContribuation);
			...
			float3 lerpResult32 = lerp( temp_cast_11 , indirectDiffuse28 , _IndirectDiffuseContribuation);
			float4 BaseColour43 = ( float4( (( tex2DNode36 * _Tint )).rgb , 0.0 ) * ( ( lerpResult34 * ase_lightColor ) + float4( ( temp_output_26_0 * ase_lightColor.a * lerpResult32 ) , 0.0 ) ) );
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float3 lerpResult32 = lerp( temp_cast_2 , float3(0,0,0) , _IndirectDiffuseContribuation);
			float4 BaseColour43 = ( float4( (( tex2DNode36 * _Tint )).rgb , 0.0 ) * ( ( lerpResult34 * ase_lightColor ) + float4( ( temp_output_26_0 * ase_lightColor.a * lerpResult32 ) , 0.0 ) ) );
			float4 temp_output_53_0 = BaseColour43;
...
/*ASEBEGIN
Version=18600
0;0;1920;1019;358.2046;2606.068;1;True;True
...
ASEEND*/
//CHKSM=087F8BE5A15AC037FB9271FFBC41F4AA4D2799C4